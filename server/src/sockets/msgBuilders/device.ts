...
) => sendToRoom(getDevRID(id), DEV_SETTINGS_UPDATE, {
    id,
    ...settings,
  });
...
export const sendCapturesUpdate = (
  id: DeviceId,
  captures: PaginatedResult<DeviceCapture>
...
export const sendNotesUpdate = (
  id: DeviceId,
  notes: PaginatedResult<DeviceNote>
...
export const sendMsgsUpdate = (
  id: DeviceId,
  messages: PaginatedResult<DeviceMessage>
